...
TextureParticleFilterTracker::TextureParticleFilterTracker()
    : pe_surf_(NULL),
...
bool TextureParticleFilterTracker::initTracker(std::string &obj_name, std::string &cam_name, std::string &intrinsic, std::string &distortion, int width, int height, CvMat *pose_init)
{
...
bool TextureParticleFilterTracker::initObjectModel(std::string name, int width, int height, CvMat *intrinsic, float sample_step, int maxd, bool dulledge, CEdgeTracker *edge_tracker)
{
...
bool TextureParticleFilterTracker::initPoseEstimationSURF(int width, int height, std::string data_name, std::string &obj_name)
{
	if(pe_surf_) delete pe_surf_;
...
bool TextureParticleFilterTracker::initKeyframes()
{
...
void TextureParticleFilterTracker::displayResults()
{
...
bool TextureParticleFilterTracker::initialize()
{
...
void TextureParticleFilterTracker::handleKey(char key)
{
	switch(key)
	{
	case 'r':
...
void TextureParticleFilterTracker::tracking()
{
