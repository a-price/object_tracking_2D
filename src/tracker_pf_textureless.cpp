...
TexturelessParticleFilterTracker::TexturelessParticleFilterTracker()
    : pe_surf_(NULL)
    , th_cm_(0.2f)
{
...
bool TexturelessParticleFilterTracker::initTracker(std::string &obj_name, std::string &cam_name, std::string &intrinsic, std::string &distortion, int width, int height, CvMat *pose_init)
{
...
bool TexturelessParticleFilterTracker::initObjectModel(std::string name, int width, int height, CvMat *intrinsic, float sample_step, int maxd, bool dulledge, CEdgeTracker *edge_tracker)
{
...
bool TexturelessParticleFilterTracker::initPoseEstimationSURF(int width, int height, std::string data_name, std::string &obj_name)
{
	if(pe_surf_) delete pe_surf_;
...
void TexturelessParticleFilterTracker::displayResults()
{
...
bool TexturelessParticleFilterTracker::initialize()
{
...
void TexturelessParticleFilterTracker::handleKey(char key)
{
	switch(key)
	{
	case 'r':
...
void TexturelessParticleFilterTracker::tracking()
{
