...
public:
	...
	CvMat* GetState(int i)
	{
		return states_[i];
	}
	vector<CvMat*>& GetStates()
	{
		return states_;
	}
	CvMat* GetPrevState(int i)
	{
		return states_prev_[i];
	}
	CvMat* GetPropState(int i)
	{
		return states_prop_[i];
	}
	CvMat* GetPredState(int i)
	{
		return states_pred_[i];
	}
	CvMat* GetOptState(int i)
	{
		return states_opt_[i];
	}
	CvMat* GetMeanState()
	{
		return mean_state_;
